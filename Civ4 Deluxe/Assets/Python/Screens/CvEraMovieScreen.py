...
class CvEraMovieScreen:
    ...
    def interfaceScreen (self, iEra):
        ...
        # Play the movie
        if iEra == 1:
            szMovie = "Art/Movies/Era/02Ancient.dds"
        elif iEra == 2:
            szMovie = "Art/Movies/Era/03Classical.dds"
        elif iEra == 3:
            szMovie = "Art/Movies/Era/04Medieval.dds"
        elif iEra == 4:
            szMovie = "Art/Movies/Era/05Renaissance.dds"
        elif iEra == 5:
            szMovie = "Art/Movies/Era/06Industrial.dds"
        elif iEra == 6:
            szMovie = "Art/Movies/Era/07Atomic.dds"
        elif iEra == 7:
            szMovie = "Art/Movies/Era/08Information.dds"
        else:
            szMovie = "Art/Movies/Era/09Future.dds"
