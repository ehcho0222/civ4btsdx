						...
						for k in range(pHeadSelectedCity.getNumBuilding(i)):
							...
							if (pHeadSelectedCity.getNumActiveBuilding(i) > 0):
								...
								for j in range( YieldTypes.NUM_YIELD_TYPES):
									...
									## Technology Affected Buildings: BEGIN	
									########################################								
									iYield = iYield = gc.getBuildingInfo(i).getYieldChange(j) + pHeadSelectedCity.getNumBuilding(i) * (pHeadSelectedCity.getBuildingYieldChange(gc.getBuildingInfo(i).getBuildingClassType(), j) + gc.getTeam(pHeadSelectedCity.getTeam()).getBuildingYieldChange(i, j))
									########################################
									## Technology Affected Buildings: END
									## Was:
